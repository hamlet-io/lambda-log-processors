    ...
    def __init__(self, log_msg):
        ...
        for split_log in log_reader:
            ...
            self.message = {
                ...
                "request_processing_time": float(split_log[5]),
                "target_processing_time": float(split_log[6]),
                "response_processing_time": float(split_log[7]),
                "elb_status_code": split_log[8],
                "target_status_code": split_log[9],
                "received_bytes": int(split_log[10]),
                "sent_bytes": int(split_log[11]),
